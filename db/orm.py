...
class Upload(Base):
    ...
    def upload_path(self) -> str:
        # Logic to compute upload file path based on metadata in the database
        return f"C:/Users/Adiel/Desktop/Excellent/final-project-AdielDror/uploads/{self.filename}"

    @property
    def error_messages(self):
        # Logic to retrieve error messages related to failed uploads
